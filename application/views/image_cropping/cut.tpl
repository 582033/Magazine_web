...
<title>（头像）截图程序</title>
<link href="/sta/styles/image_cropping.css" rel="stylesheet" type="text/css">
</head>
<body>
<div id="allBox">
  <div id="picBox">
...
<!--
//关于图片处理
var _cutMinW=180; //切片最小宽度
var _cutMinH=180; //切片最小高度
var _imgPath=getCookie('letoupath'); //图片路径
{literal}
