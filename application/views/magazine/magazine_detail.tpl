...
<div class="main mag_preview clearfix">
	<div class="left_main">
		...
		<div class="intro">
			...
			<p class="readonline">
				...
				<a class="mag_dl" href="{$bookshelf_download_url}" target="_bank"></a>
			</p>
		...
		<dl class="preview">
			...
			<dd class="scrollbar">
					<ul>
						...
						<li tabindex="0"><a href="{$pub_host}/{$magazine.id|truncate:3:''}/{$magazine.id}/web/#{$item.pageId}"><img src="{$item.thumbUrl}" alt="page 16" width="104px" height="160px" style="overflow:hidden;" /></a></li>
						{/foreach}
					</ul>
			</dd>
		</dl>
	...
	<div class="sidebar_right">
		<div class="topic">
			<a href="/soft"><img src="/sta/images/app_logo.jpg?v=1.0" width=230 height=180 alt="预览" /></a>
		</div>
		<dl class="mag_topic">
			<dt>推荐的杂志</dt>
