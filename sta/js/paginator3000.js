...
Paginator.prototype.prepareHtml = function() {
	...
	this.html.table = this.html.holder;
	...
	if (this.inputData.pagesSpan == this.inputData.pagesTotal) {
		...
		this.html.scrollThumb.style.display="none";
	}
}

Paginator.prototype.makePagesTableHtml = function() {
//	var tdWidth = (100 / this.inputData.pagesSpan) + '%';
	var html = '' + '<ul class="pagenav clearfix">'
	for (var i = 1; i <= this.inputData.pagesSpan; i++) {
		html += '<li></li>';
	}
	html += '</li></ul>' ;
	html += '<div class="scroll_bar">' + '<div class="scroll_trough"></div>' + '<div class="scroll_thumb">' + '<div class="scroll_knob"></div>' + '</div>' + '<div class="current_page_mark"></div>' + '</div>';
	return html;
}
...
Paginator.prototype.initPageCurrentMark = function() {
	...
	this.html.pageCurrentMark.widthPercent = 100 / this.inputData.pageOneNum;
...
Paginator.prototype.drawPages = function() {
	...
	for (var i = 0; i < this.html.tdsPages.length; i++) {
		...
		if (cellCurrentValue == this.inputData.pageCurrent) {
			html = "<strong>" + cellCurrentValue + "</strong>";
		} else {
			html = "<a href='" + this.inputData.baseUrl + cellCurrentValue + this.inputData.afterBase + "'>" + cellCurrentValue + "</a>";
		}
